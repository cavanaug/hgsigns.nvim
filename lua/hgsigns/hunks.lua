...
--- @alias Hgsigns.Hunk.Type
--- | "add"
--- | "change"
--- | "delete"

--- @class (exact) Hgsigns.Hunk.Node
--- @field start integer
--- @field count integer
--- @field lines string[]
--- @field no_nl_at_eof? true

--- @class (exact) Hgsigns.Hunk.Hunk
--- @field type Hgsigns.Hunk.Type
--- @field head string
--- @field added Hgsigns.Hunk.Node
--- @field removed Hgsigns.Hunk.Node
--- @field vend integer

--- @class (exact) Hgsigns.Hunk.Hunk_Public
--- @field type Hgsigns.Hunk.Type
--- @field head string
--- @field lines string[]
--- @field added Hgsigns.Hunk.Node
...
--- @param hunk Hgsigns.Hunk.Hunk
--- @param next_hunk Hgsigns.Hunk.Hunk?
...
--- Calculate signs needed to be applied from a hunk for a specified line range.
--- @param prev_hunk Hgsigns.Hunk.Hunk?
--- @param hunk Hgsigns.Hunk.Hunk
--- @param next_hunk Hgsigns.Hunk.Hunk?
--- @param min_lnum? integer
--- @param max_lnum? integer
...
--- @param lnum integer
--- @param hunks Hgsigns.Hunk.Hunk[]?
--- @return Hgsigns.Hunk.Hunk?, integer?
...
--- @param a Hgsigns.Hunk.Hunk[]?
--- @param b Hgsigns.Hunk.Hunk[]?
--- @return boolean
...
function M.linespec_for_hunk(hunk, fileformat)
  local hls = {} --- @type [string, string|Hgsigns.HlMark[], string?][][]
