...
local create_hunk = require('hgsigns.hunks').create_hunk
...
--- @alias Hgsigns.Region [integer, string, integer, integer]
--- @alias Hgsigns.RawHunk [integer, integer, integer, integer]

---@param a string
---@param b string
---@param opts Hgsigns.DiffOpts
---@param linematch? boolean
---@return Hgsigns.RawHunk[]
...
--- @param fa string[]
--- @param fb string[]
--- @param rawhunks Hgsigns.RawHunk[]
...
--- @param added string[]
--- @return Hgsigns.Region[] removed
--- @return Hgsigns.Region[] added
function M.run_word_diff(removed, added)
  local adds = {} --- @type Hgsigns.Region[]
  local rems = {} --- @type Hgsigns.Region[]
