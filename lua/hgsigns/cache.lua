...
--- @class (exact) Hgsigns.CacheEntry.Blame
--- @field entries table<integer,Hgsigns.BlameInfo?>
--- @field max_time? integer
--- @field min_time? integer

--- @class (exact) Hgsigns.CacheEntry
--- @field bufnr              integer
--- @field file               string
--- @field compare_text?      string[]
--- @field hunks?             Hgsigns.Hunk.Hunk[]
...
--- @field commits?           table<string,Hgsigns.CommitInfo?>
...
--- @param bufnr integer
--- @param file string
--- @param git_obj Hgsigns.GitObj
--- @return Hgsigns.CacheEntry
...
function CacheEntry:get_hunks(greedy)
  if greedy and config.diff_opts.linematch then
    ...
    local run_diff = require('hgsigns.diff')
...
---@type table<integer,Hgsigns.CacheEntry?>
M.cache = {}
