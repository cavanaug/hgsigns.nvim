...
local Capture = require('hgsigns.render.capture')
local Overlay = require('hgsigns.render.overlay')
...
--- @class (exact) Hgsigns.HunkPreview.SourceBuf
--- @field bufnr integer
--- @field version any
...
--- @param source_cache? table<string, Hgsigns.HunkPreview.SourceBuf>
--- @param bufnr integer
--- @param lines string[]
...
local function ensure_cached_source_buf(source_cache, bufnr, lines, cache_key)
  ...
  local source_buf = source_cache[cache_key] --- @type Hgsigns.HunkPreview.SourceBuf?
...
--- @param opts? {source_cache?: table<string, Hgsigns.HunkPreview.SourceBuf>, cache_key?: string}
--- @return integer source_bufnr
--- @return fun() cleanup
...
--- @param lines Hgsigns.CapturedLine[]
--- @param line_hl? Hgsigns.HlName|Hgsigns.HlStack
--- @param word_diff? [integer, string, integer, integer][]
--- @param word_diff_hl Hgsigns.HlName|fun(region_type: string, region: [integer, string, integer, integer]): Hgsigns.HlName?
--- @param line_priority? integer
--- @param word_diff_priority? integer
--- @return Hgsigns.CapturedLine[]
...
local function word_diff_regions(removed, added, kind)
  local removed_regions, added_regions = require('hgsigns.diff_int').run_word_diff(removed, added)
...
local function removed_word_diff_regions(bufnr, hunk)
  ...
  local removed_regions = require('hgsigns.diff_int').run_word_diff(removed, added)
...
--- @param opts {line_hl: Hgsigns.HlName|Hgsigns.HlStack, word_diff?: boolean, word_diff_hl: Hgsigns.HlName|fun(region_type: string, region: [integer, string, integer, integer]): Hgsigns.HlName?}
--- @return Hgsigns.CapturedLine[][]
function M.capture_removed_hunks_from_source(bufnr, source_bufnr, hunks, opts)
  local ret = {} --- @type Hgsigns.CapturedLine[][]
...
--- @param hunks Hgsigns.Hunk.Hunk[]
--- @param staged boolean?
--- @param opts {source_cache?: table<string, Hgsigns.HunkPreview.SourceBuf>, line_hl: Hgsigns.HlName|Hgsigns.HlStack, word_diff?: boolean, word_diff_hl: Hgsigns.HlName|fun(region_type: string, region: [integer, string, integer, integer]): Hgsigns.HlName?}
--- @return Hgsigns.CapturedLine[][]
...
--- @param layer Hgsigns.RenderLayer
--- @param text_len integer
--- @return Hgsigns.HlMark?
...
local function render_popup_lines(lines, opts)
  ...
  local ret = {} --- @type Hgsigns.LineSpec[]
  for i, line in ipairs(lines) do
    local marks = {} --- @type Hgsigns.HlMark[]
...
--- @param added_node Hgsigns.Hunk.Node
--- @return Hgsigns.LineSpec[]
