...
--- @param layers Hgsigns.RenderLayer[]
...
--- @param hl_group Hgsigns.HlName|Hgsigns.HlStack
...
--- @param region_hl Hgsigns.HlName|fun(region_type:string, region:[integer,string,integer,integer]):Hgsigns.HlName?
--- @param priority integer
