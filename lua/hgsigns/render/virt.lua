...
--- @class Hgsigns.RenderLayer
--- @field start_col integer
--- @field end_col integer
--- @field priority integer
--- @field hl_group Hgsigns.HlName|Hgsigns.HlStack

--- @class Hgsigns.CapturedLine
--- @field text string
--- @field layers Hgsigns.RenderLayer[]

--- @class Hgsigns.RenderVirtOpts
--- @field pad_width? integer
--- @field pad_hl? Hgsigns.HlName|Hgsigns.HlStack
--- @field default_hl? Hgsigns.HlName|Hgsigns.HlStack
--- @field pad_with_eol_hl? boolean
--- @field prefix? Hgsigns.VirtTextChunk[][]|fun(line_index: integer, line: Hgsigns.CapturedLine): Hgsigns.VirtTextChunk[]?

--- @param chunks Hgsigns.VirtTextChunk[]
--- @param text string
...
local function copy_chunks(chunks)
  local ret = {} --- @type Hgsigns.VirtTextChunk[]
...
--- @param opts Hgsigns.RenderVirtOpts
--- @param line_index integer
--- @param line Hgsigns.CapturedLine
--- @return Hgsigns.VirtTextChunk[]
local function line_prefix(opts, line_index, line)
  ...
  --- @cast prefix Hgsigns.VirtTextChunk[][]
