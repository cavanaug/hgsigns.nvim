...
--- @alias Hgsigns.LineSpec [string, string|Hgsigns.HlMark[], string?][]

--- @param hlmarks Hgsigns.HlMark[]
...
--- Partition the text and Hgsigns.HlMarks from a Hgsigns.LineSpec[]
--- @param fmt Hgsigns.LineSpec[]
--- @return string[]
--- @return Hgsigns.HlMark[]
local function partition_linesspec(fmt)
  local lines = {} --- @type string[]
  local ret = {} --- @type Hgsigns.HlMark[]
