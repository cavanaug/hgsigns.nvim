...
--- @param item Hgsigns.InspectItem
--- @param row integer
...
--- @return Hgsigns.RenderLayer[]
local function layers_from_inspected(inspected)
  local layers = {} --- @type Hgsigns.RenderLayer[]
...
function M.capture_lines(bufnr, start_row, count, opts)
  opts = opts or {}
  local lines = {} --- @type Hgsigns.CapturedLine[]
...
--- @param line Hgsigns.CapturedLine
--- @return Hgsigns.CapturedSegment[]
function M.segments(line)
  local segments = {} --- @type Hgsigns.CapturedSegment[]
