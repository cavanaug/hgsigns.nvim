...
--- @class hgsigns.debounce.debounce_trailing.Opts
...
---
--- @generic F: function
--- @param opts hgsigns.debounce.debounce_trailing.Opts|integer|fun():integer
...
--- @class hgsigns.debounce.throttle_async.Opts
--- @field hash? integer|fun(...): any Function that determines id from arguments to fn
...
---
--- @generic T
--- @param opts hgsigns.debounce.throttle_async.Opts
