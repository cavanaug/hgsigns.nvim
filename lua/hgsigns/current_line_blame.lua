...
--- @param virt_text Hgsigns.BlameFmtChunk[]
--- @return string
...
---@param blame_info Hgsigns.BlameInfoPublic
...
--- @param bcache Hgsigns.CacheEntry
--- @param lnum integer
--- @param blame_info Hgsigns.BlameInfo
--- @param opts Hgsigns.CurrentLineBlameOpts
