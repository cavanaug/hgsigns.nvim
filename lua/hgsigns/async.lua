...
--- @type table<thread,Hgsigns.async.Task?>
...
--- @class Hgsigns.async.Handle
--- @field close fun(self: Hgsigns.async.Handle, callback?: fun())
--- @field is_closing? fun(self: Hgsigns.async.Handle): boolean

--- @alias Hgsigns.async.CallbackFn fun(...: any): Hgsigns.async.Handle?

--- @class Hgsigns.async.Task<R> : Hgsigns.async.Handle
...
--- cancel it.
--- @field private _current_child? Hgsigns.async.Handle
---
...
function Task:_resume(...)
  ...
  --- @type [boolean, string|Hgsigns.async.CallbackFn]
...
--- ```
--- @async
--- @overload fun(func: Hgsigns.async.CallbackFn): any ...
--- @overload fun(argc: integer, func: Hgsigns.async.CallbackFn, ...:any): any ...
--- @overload fun(task: Hgsigns.async.Task): any ...
function M.await(...)
...
do --- M.semaphore()
  ...
  --- @class Hgsigns.async.Semaphore
  --- @field private _permits integer
  --- @field private _max_permits integer
  --- @field package _event Hgsigns.async.Event
  local Semaphore = {}
  ...
  --- @return Hgsigns.async.Semaphore
