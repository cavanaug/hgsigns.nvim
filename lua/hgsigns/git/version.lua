...
local gs_config = require('hgsigns.config')

local log = require('hgsigns.debug.log')
local err = require('hgsigns.message').error
local system = require('hgsigns.system').system
local tointeger = require('hgsigns.util').tointeger
...
--- @class (exact) Hgsigns.Version
--- @field major integer
--- @field minor integer
--- @field patch integer

--- @param version string
--- @return Hgsigns.Version
