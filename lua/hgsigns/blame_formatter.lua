...
--- @class (exact) Hgsigns.BlameLineHighlight
...
--- @return Hgsigns.BlameInfoPublic
...
--- @param username string
--- @param info Hgsigns.BlameInfoPublic
--- @param opts? { self_author_text?: string, token_hls?: table<string, Hgsigns.HlName|Hgsigns.HlStack> }
--- @return Hgsigns.BlameFmtChunk[]
--- @return boolean
...
--- @param chunks Hgsigns.BlameFmtChunk[]
--- @return string
--- @return Hgsigns.BlameLineHighlight[]
--- @return integer
function M.render_line(chunks)
  local highlights = {} --- @type Hgsigns.BlameLineHighlight[]
