...
--- @class (exact) Hgsigns.DiffthisOpts
---
...
--- @class (exact) Hgsigns.SignConfig
--- @field show_count boolean
--- @field text string

--- @alias Hgsigns.SignType
--- | 'add'
--- | 'change'
--- | 'delete'
--- | 'topdelete'
...
--- @field diff_opts Hgsigns.DiffOpts
...
--- @field status_formatter fun(_: Hgsigns.StatusObj): string
...
--- @class Hgsigns.config
local M = {}

--- @alias Hgsigns.Config.SubscribersCb fun(old_val:any, new_val:any)
--- @type table<string, Hgsigns.Config.SubscribersCb[]>
local subscribers = {}
...
--- @return Hgsigns.DiffOpts
local function parse_diffopt()
  --- @type Hgsigns.DiffOpts
  local r = {
    algorithm = 'myers',
    internal = false,
...
--- @type table<string,Hgsigns.SchemaElem>
M.schema = {
  signs = {
    type_help = 'table',
    type = validate_signs,
  ...
  diff_opts = {
    ...
    default_change = function(callback)
      vim.api.nvim_create_autocmd('OptionSet', {
        group = vim.api.nvim_create_augroup('hgsigns.config.diff_opts', {}),
        pattern = 'diffopt',
        callback = callback,
      })
    end,
...
--- @param cb Hgsigns.Config.SubscribersCb
